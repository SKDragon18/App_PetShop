...
public class ManageScreenEmployee extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_manage_employee_screen, container, false);
        tabLayout = mView.findViewById(R.id.tab_layout);
        viewPager=mView.findViewById(R.id.manage_viewpager);

        ManageEmployeeAdapter adapter = new ManageEmployeeAdapter(getChildFragmentManager(), FragmentStatePagerAdapter.BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT);
