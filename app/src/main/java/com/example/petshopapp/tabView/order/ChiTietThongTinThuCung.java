...
public class ChiTietThongTinThuCung extends Fragment {
    private View mView;
    private TextView tvTenThuCung, tvTenGiong, tvMoTa, tvGia;
    private ImageView ivHinhAnh;
    private Button btnBack, btnAdd;

    private BangGiaThuCung bangGiaThuCung;
    private String maKhachHang;
    private GioHangService gioHangService;
    public ChiTietThongTinThuCung() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_chi_tiet_thong_tin_thu_cung, container, false);
        Bundle bundle =getArguments();
        if(bundle!=null){
            bangGiaThuCung =(BangGiaThuCung) bundle.getSerializable("bangGiaThuCung");
    ...
    private void setInit(){
        ...
        tvMoTa = mView.findViewById(R.id.tvMoTa);
        ...
        if(bangGiaThuCung!=null){
            tvTenThuCung.setText(bangGiaThuCung.getTenThuCung());
            tvTenGiong.setText(bangGiaThuCung.getTenGiong());
            tvMoTa.setText(bangGiaThuCung.getMoTa());
            BigDecimal giaHT = bangGiaThuCung.getGiaHienTai();
            BigDecimal giaKM = bangGiaThuCung.getGiaKhuyenMai();
            if(giaKM!=null){
            ...
            String hinhAnh = bangGiaThuCung.getHinhAnh();
